...
double Payment::accrual() { return _balance; }
...
double Deposit::accrual() { return _balance + (_balance / 100 * (_percent / 12)); }
...
double Credit::accrual() { return _balance - (abs(_balance) / 100 * _percent / 12); }
